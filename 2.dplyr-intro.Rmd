...
Various patient characteristics have been generated and saved in the file [patient-data.txt](patient-data). 
...
N.B. base R did provide a function called `subset` which allowed similar operations.
